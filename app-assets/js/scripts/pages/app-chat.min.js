...
function enterChat(s) {
    var e = $(".message").val(),
        attachedImage = getAttachedImageSrc(),
        a = document.createElement("div");
    a.classList.add("chat-content");
    // a.addClass("chat-content");

    // a = `<div class="chat-content">`;

    if (attachedImage) {
        a.appendChild(drawEditedImage());

        // a += drawEditedImage() `<img class="chat-image" src="${attachedImage}" alt=""/>`;
        // a.append(drawEditedImage());
...
function chaoticEncryption(src) {
    ...
    img.onload = () => {
        /*
                ...
                ctx.drawImage(file.img, 0, 0, 150, 150);
        */

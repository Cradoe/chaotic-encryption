...
function enterChat(s) {
    var e = $(".message").val(),
        attachedImage = getAttachedImageSrc($('#image-attachment')),
        a = a = `<div class="chat-content">`;

    if (attachedImage) {
        a += `<img class="chat-image" src="${attachedImage}" alt=""/>`;
    ...
    const template = `<div class="chat ${chat.sent_by == receipientId ? 'chat-left': null} ">
                        <div class="chat-avatar">
                            <span class="avatar box-shadow-1 cursor-pointer">
                                <img src="${chat.image}" alt="avatar" height="36" width="36" />
                            </span>
                        </div>
                        <div class="chat-body">
...
function shuffle(inArr, unshuffle = false) {
    let outArr = inArr,
        len = inArr.length
...
function chaoticEncryption(src) {
    ...
    const img = new Image(),
        ...
        canvasEdited = document.getElementById('canvasEdited'),
        reCanvas = document.getElementById('reCanvas'),
